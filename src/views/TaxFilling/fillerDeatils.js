...
const FillerDetails = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    taxPayerStatus: "0", // Default to "No" (Single)
    spouseFirstName: "",
    spouseMiddleInitial: "",
    spouseLastName: "",
    spouseSsnOrItin: "",
      ...
      <Container>
        <Formik
          ...
          validationSchema={Yup.object().shape({
            ...
            taxYear: Yup.string().max(255).required("Tax Year is required"),
            ...
            taxFiledLastYear: Yup.string().required("Please select an option"),
            taxPayerStatus: Yup.string().required("Please select your status"),

            // additional Spouse Details (Add validation rules as needed)
            spouseFirstName: Yup.string().when("taxPayerStatus", {
              is: "1", // "1" indicates "Married"
            ...
            additionalFirstName: Yup.string().when("taxPayerStatus", {
              is: "1", // "1" indicates "Married"
              then: Yup.string().required("additional First Name is required"),
              otherwise: Yup.string(),
            }),
            ...
            additionalDateOfBirth: Yup.date().when("taxPayerStatus", {
              is: "1", // "1" indicates "Married"
              then: Yup.date().required("additional Date of Birth is required"),
              otherwise: Yup.date(),
            }),
            ...
            additionalOccupation: Yup.string().when("taxPayerStatus", {
              is: "1", // "1" indicates "Married"
              then: Yup.string().required("additional Occupation is required"),
              otherwise: Yup.string(),
            }),
              ...
              <Grid container sx={{ marginBottom: "30px" }}>
                ...
                >
                  <Typography variant="body1">
                    ...
                    support to your kids and/or dependents during the tax year?
                  </Typography>
                </Grid>
                <Grid item xs={2} sm={3}>
                  <TextField
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item sm={12} xs={12}>
                        <TextField
                          ...
                          variant="outlined"
                          error={Boolean(
                            touched.additionalGender && errors.additionalGender
                          )}
                          helperText={
                            touched.additionalGender && errors.additionalGender
                          }
